...
list2 = [10, 11,12,13.py,14,15,16,17,18,19]
str1 = "hello world"
for x in range(3000):
    print(x)
...
import sys
import time as t
 打印时间戳，也称为UNIX时间，自1970年1月1日0点0分0秒到目前为止，累积的毫秒数
t1 = t.time()
# print(t1)
...
print("%-13s%-13s%-13s" % ("name", "age", "height"))
print("%-13s%-13d%-13.py.2f" % ("James", 19, 1.7856))
print("%-13s%-13d%-13.py.2f" % ("xxx", 33, 18))
